...
const Chathistory = ({ chats, setChats, onSelectChat }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`overflow-y-auto top-0 left-0 z-40 h-full w-64 bg-[#130E21] text-white shadow-lg transform transition-transform duration-300 ease-in-out
                ...
                >
                  ...
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity">
                    <Ellipsis
                      ...
                      onClick={() =>
                        setShowMenuForId((prev) => (prev === chat.id ? null : chat.id))
                      }
                    />
                  </div>
                  ...
                  {showMenuForId === chat.id && (
                    <div className="absolute right-2 top-10 z-50 w-48 bg-gradient-to-br from-[#1e002c] via-[#3a006f] to-[#120026] text-white shadow-lg rounded-md border border-zinc-700 py-2 text-sm">
                      ...
                      <button
                        ...
                        className="flex cursor-pointer w-full items-center gap-2 px-4 py-2 text-left hover:bg-red-600 transition-colors hover:rounded-lg"
                      >
                        <Trash2 size={16} className="text-white" />
